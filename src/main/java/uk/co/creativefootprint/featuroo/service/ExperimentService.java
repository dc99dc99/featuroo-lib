...
public class ExperimentService {
    ...
    public Alternative convert(String name, Client client, Date dateTime, Goal goal) throws NotParticipatingException{
        ...
        experiment.convert(client, goal);

        conversionRepository.convert(experiment, client, goal, dateTime);
